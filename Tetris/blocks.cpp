// all the child classes - one for each block
#include "block.h"
#include "position.h"
...
public:
	LBlock()
	{
		...
		cells[1] = { Position(0, 0), Position(0, 1), Position(1, 1), Position(2, 1) };
		Move(0, 3);
	}
};
...
public:
	JBlock()
	{
		...
		cells[1] = { Position(0, 1), Position(1, 1), Position(2, 0), Position(2, 1) };
		Move(0, 3);
	}
};
